...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        // Current script rules apply from the start of this new chain.
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x03, 0x0A, 0xA3, 0xDA};
        base58Prefixes[EXT_SECRET_KEY] = {0x03, 0x0A, 0xA3, 0xDB};
